				...
				<div class="col-lg-4 col-md-6 mb-20">
					<div class="card-box height-100-p pd-20 min-height-200px">
						<div class="d-flex justify-content-between pb-10">
							<div class="h5 mb-0">Approvers</div>
							<div class="table-actions">
								<a title="VIEW" href="department.php"><i class="icon-copy ion-disc" data-color="#17a2b8"></i></a>	
							</div>
						</div>
						<div class="user-list">
							<ul>
								<?php
		                         $query = mysqli_query($conn,"select * from tblemployees where role='Approver' ORDER BY tblemployees.emp_id desc limit 4") or die(mysqli_error());
				...
				<div class="col-lg-4 col-md-6 mb-20">
					<div class="card-box height-100-p pd-20 min-height-200px">
						...
						<div class="user-list">
							<ul>
								<?php
		                         $query = mysqli_query($conn,"select * from tblemployees where role='Employee' ORDER BY tblemployees.emp_id desc limit 3") or die(mysqli_error());
		                         while ($row = mysqli_fetch_array($query)) {
		                         $id = $row['emp_id'];
		                             ?>
					...
					<table class="data-table table stripe hover nowrap">
						...
						<tbody>
							<tr>
								...
								$status=0;
								$reg_status=0;
								$sql = "SELECT tblleaves.id as lid,tblemployees.FirstName,tblemployees.LastName,tblemployees.location,tblemployees.emp_id,tblleaves.LeaveType,tblleaves.PostingDate,tblleaves.Status, tblleaves.admin_status, tblleavetype.LeaveType as 'leavename', tblleavetype.id as empleave from tblleaves join tblemployees on tblleaves.empid=tblemployees.emp_id INNER JOIN tblleavetype ON tblleaves.LeaveType = tblleavetype.id where tblleaves.Status= '$status' order by lid desc limit 5";
