							...
							<td><?php echo $row['leavename']; ?></td>
								...
								<td>
									<div class="table-actions">
										<a title="VIEW" href="leave_details.php?leaveid=<?php echo $row['lid']; ?>&&empid=<?php echo $row['emp_id']?>&&leavetypeid=<?php echo $row['empleave']; ?>"><i class="dw dw-eye" data-color="#265ed7"></i></a>	
									</div>
								</td>
							</tr>
							<?php }?>
