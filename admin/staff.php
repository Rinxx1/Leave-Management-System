			...
			<div class="row pb-10">
				...
				<div class="col-xl-3 col-lg-3 col-md-6 mb-20">
					<div class="card-box height-100-p widget-style3">
						...
						<?php 
						 $query_reg_staff = mysqli_query($conn,"select * from tblemployees where role = 'Employees' ")or die(mysqli_error());
				...
				<div class="col-xl-3 col-lg-3 col-md-6 mb-20">
					<div class="card-box height-100-p widget-style3">
						...
						<?php 
						 $query_reg_hod = mysqli_query($conn,"select * from tblemployees where role = 'Approver' ")or die(mysqli_error());
						...
						<div class="d-flex flex-wrap">
							<div class="widget-data">
								...
								<div class="font-14 text-secondary weight-500">Heads</div>
							</div>
							<div class="widget-icon">
