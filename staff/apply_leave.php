<?php include('includes/header.php')?> <?php include('../includes/session.php')?> <?php 
	...
	{
	    echo "
<script>alert('End Date should be greater than Start Date');</script>";
	  }
		...
		$sql="INSERT INTO tblleaves(LeaveType,ToDate,FromDate,Description,Status,IsRead,empid,num_days,PostingDate,files) VALUES(:leave_type,:fromdate,:todate,:description,:status,:isread,:empid,:num_days,:datePosting,:files)";
		...
		{
			echo "
<script>alert('Leave Application was successful.');</script>";
			echo "
<script type='text/javascript'> document.location = 'leave_history.php'; </script>";
		}
		else 
		{
			echo "
...
?> <body> <?php include('includes/navbar.php')?> <?php include('includes/right_sidebar.php')?> <?php include('includes/left_sidebar.php')?> <div class="mobile-menu-overlay"></div>
      ...
      <div class="min-height-200px">
        ...
        <div style="margin-left: 50px; margin-right: 50px;" class="pd-20 card-box mb-30">
          ...
          <div class="wizard-content">
            ...
            <form enctype="multipart/form-data" method="post" action="deductcreditsquery.php?empid=<?php echo $session_id; ?>">
