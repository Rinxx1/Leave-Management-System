			...
			<div class="min-height-200px">
				...
				<div class="pd-20 card-box mb-30">
					...
					<form method="post" action="">
						...
						<div class="form-group row">
								<label style="font-size:16px;" class="col-sm-12 col-md-2 col-form-label"><b>Department Head Remarks</b></label>
								<div class="col-sm-12 col-md-10">
									<?php
						...
						<div class="form-group row">
								<label style="font-size:16px;" class="col-sm-12 col-md-2 col-form-label"><b>HR STATUS</b></label>
								<div class="col-sm-12 col-md-10">
									<?php
