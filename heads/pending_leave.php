					...
					<table class="data-table table stripe hover nowrap">
						...
						<tbody>
							<tr>
								...
								<?php 
								$status=0;
								$sql = "SELECT tblleaves.id as lid,tblemployees.FirstName,tblemployees.LastName,tblemployees.location,tblemployees.emp_id,tblleaves.LeaveType,tblleaves.PostingDate,tblleaves.Status,tblleaves.admin_status, tblleavetype.LeaveType as 'leavename' from tblleaves join tblemployees on tblleaves.empid=tblemployees.emp_id INNER JOIN tblleavetype ON tblleaves.LeaveType = tblleavetype.id where tblleaves.Status= '$status' and tblemployees.department = '$session_depart' order by lid desc";
